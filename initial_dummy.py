...
if __name__ == "__main__":
    ...
    # glutCreateWindow (via PyOpenGL/ctypes) expects a C string pointer (c_char_p)
    # Some builds accept bytes, others expect ctypes.c_char_p. Accept either
    # a Python str or bytes and convert safely.
    def _create_window(title):
        ...
        try:
            ...
            # Some implementations require explicit c_char_p
            from ctypes import c_char_p
            glutCreateWindow(c_char_p(title))

    _create_window("Analog Speedometer - Python OpenGL")
